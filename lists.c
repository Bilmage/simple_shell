...
/**
 * addNodeToFront - Add a node to the beginning of the list.
...
/**
 * addNodeToEnd - Add a node to the end of the list.
 * @head: Pointer to the address of the head node.
 * @str: The string field of the node.
 * @num: The node index used for history.
 *
...
/**
 * printListStrings - Print only the 'str' element of a list_t linked list.
...
/**
 * deleteNodeAtIndex - Delete a node at the given index.
...
/**
 * freeListNodes - Free all nodes of a list.
 * @headPtr: Pointer to the address of the head node.
 *
 * Return: void.
 */
